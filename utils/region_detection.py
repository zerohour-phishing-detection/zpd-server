...
def _find_regions(image : cv2.typing.MatLike, image_path : str, draw : bool, highlight_name : str, invert = True) -> list['RegionData']:
    """
    ...
    for index, contour in enumerate(contours):
        ...
        if len(hierarchy) > 0:
            regions_data.append(RegionData(region_data, index, x, y, unique_colors_count, pct, hierarchy[0][index], invert, mean, std, skew, kurtosis, entropy, otsu, energy, occupied_bins))
        else:
