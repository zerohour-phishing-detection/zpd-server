...
#	sstructural_sim = structural_sim(img_a, img_b)
#	spixel_sim = pixel_sim(img_a, img_b)
#	ssift_sim = orb_sim(img_a, img_b)
#	emd = earth_movers_distance(img_a, img_b)
#	print("Random images:")
#	print(sstructural_sim, spixel_sim, ssift_sim, #emd)
#	
#	sstructural_sim = structural_sim(img_a, img_a)
#	spixel_sim = pixel_sim(img_a, img_a)
#	ssift_sim = orb_sim(img_a, img_a)
#	emd = earth_movers_distance(img_a, img_a)
