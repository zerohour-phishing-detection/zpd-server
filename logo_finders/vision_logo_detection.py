...
class VisionLogoDetection(LogoFinder):
    ...
    async def find(self, img_path, settings: DSTSettings) -> AsyncIterator[str]:
        ...
        for logo_name in logo_names:
            ...
            # Take top `gcv_top_results` search results
            for logo_url in itertools.islice(self.text_search.query(logo_name), settings.gcv_top_results):
                yield logo_url
